...
package gradle.kotlin.dsl.plugins._114f0ef114387a524b1278541ab9f0ec
...
/**
 * The `org.openjfx` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgOpenjfxPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.openjfx`.
 */
internal
val `OrgPluginGroup`.`openjfx`: `OrgOpenjfxPluginGroup`
    get() = `OrgOpenjfxPluginGroup`(plugins)


/**
 * The `org.openjfx.javafxplugin` plugin implemented by [org.openjfx.gradle.JavaFXPlugin].
 */
internal
val `OrgOpenjfxPluginGroup`.`javafxplugin`: PluginDependencySpec
    get() = plugins.id("org.openjfx.javafxplugin")
