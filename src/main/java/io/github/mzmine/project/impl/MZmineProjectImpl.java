...
public class MZmineProjectImpl implements MZmineProject {
  ...
  @Override
  public @NotNull ObservableList<RawDataFile> getObservableRawDataFiles() {
    return rawDataFiles;
  }


  @Override
  public @NotNull ObservableList<FeatureList> getObservableFeatureLists() {
    return featureLists;
  }
  ...
  @Override
  public @NotNull ObservableList<SpectralLibrary> getObservableSpectralLibraries() {
