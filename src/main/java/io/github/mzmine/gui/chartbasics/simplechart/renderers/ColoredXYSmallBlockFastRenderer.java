...
public class ColoredXYSmallBlockFastRenderer extends AbstractXYItemRenderer
   ...
   * disabled by default.
   */
  public ColoredXYSmallBlockFastRenderer() {
    updateOffsets();
  ...
  public XYItemRendererState initialise(Graphics2D g2, Rectangle2D dataArea, XYPlot plot,
    ...
    XYItemRendererState state = super.initialise(g2, dataArea, plot, dataset,
        info);
...
//    }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof ColoredXYSmallBlockFastRenderer)) {
      return false;
    }
    ColoredXYSmallBlockFastRenderer that = (ColoredXYSmallBlockFastRenderer) obj;
  ...
  public Object clone() throws CloneNotSupportedException {
    ColoredXYSmallBlockFastRenderer clone = (ColoredXYSmallBlockFastRenderer) super.clone();
