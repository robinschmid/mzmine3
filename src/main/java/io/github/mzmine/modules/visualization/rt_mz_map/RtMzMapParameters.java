 ...
 */
public class RtMzMapParameters extends SimpleParameterSet {

  public static final ComboParameter<ScanDataType> plotType =
      new ComboParameter<>("Data type",
          "Raw or centroid (for centroid run mass detection first)",
          ScanDataType.values(), ScanDataType.RAW);
